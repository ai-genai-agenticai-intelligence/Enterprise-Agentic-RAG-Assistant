...
# Portkey-backed LLM: fast 20b model for intent routing (saves 120b quota for synthesis)
llm = get_langchain_llm(feature="planner", model_name="openai/gpt-oss-20b")
